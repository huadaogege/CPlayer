...
class MainViewController: UITabBarController {
    override func viewDidLoad() {
        super.viewDidLoad()
        self.tabBar.tintColor = UIColor(red: 13/255, green:107/255, blue:13/255, alpha:1)
        
        let fileListVC = FileListViewController()
        let fileListNav = UINavigationController(rootViewController: fileListVC)
        fileListNav.navigationBar.barTintColor = UIColor(red: 13/255, green:107/255, blue:13/255, alpha:1)
        ...
        photoAlbumNav.navigationBar.barTintColor = UIColor(red: 13/255, green:107/255, blue:13/255, alpha:1)
        ...
        playOnlineNav.navigationBar.barTintColor = UIColor(red: 13/255, green:107/255, blue:13/255, alpha:1)
        ...
        setNav.navigationBar.barTintColor = UIColor(red: 13/255, green:107/255, blue:13/255, alpha:1)
